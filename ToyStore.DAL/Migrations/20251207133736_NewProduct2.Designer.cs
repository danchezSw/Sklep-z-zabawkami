...
namespace ToyStore.DAL.Migrations
{
    ...
    [Migration("20251207133736_NewProduct2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToyStore.Model.DataModels.ProductAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ToyStore.Model.DataModels.ProductVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ToyStore.Model.DataModels.ProductVariantAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ToyStore.Model.DataModels.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ToyStore.Model.DataModels.ProductVariantAttribute", b =>
                {
                    b.HasOne("ToyStore.Model.DataModels.ProductAttribute", "Attribute")
                        .WithMany()
                        .HasForeignKey("AttributeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ToyStore.Model.DataModels.ProductVariant", "Variant")
                        .WithMany("Attributes")
